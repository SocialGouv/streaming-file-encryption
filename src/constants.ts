...
export const HEADER_IV_OFFSET = HEADER_VERSION_LENGTH
export const HEADER_SALT_OFFSET = HEADER_IV_OFFSET + CIPHER_IV_LENGTH
export const HEADER_LENGTH = HEADER_SALT_OFFSET + KDF_SALT_LENGTH
