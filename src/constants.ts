...
export const PAGE_SIZE = 16 * 1024 // 16kiB
export const CLEARTEXT_PAGE_SIZE = PAGE_SIZE
export const CIPHERTEXT_PAGE_SIZE = 2 + PAGE_SIZE + CIPHER_AUTH_TAG_LENGTH
export const MAX_PADDING_LENGTH = PAGE_SIZE
